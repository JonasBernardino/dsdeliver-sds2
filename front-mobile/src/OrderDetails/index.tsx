    ...
    return (
        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <RectButton style={styles.button} onPress={handleStrartNavigation}>
                    <Text style={styles.buttonText}>INICIAR NAVEGAÇÃO</Text>
                </RectButton>

                <RectButton style={styles.button} onPress={handleOnConfirm}>
                    <Text style={styles.buttonText}>COMFIRMAR ENTREGA</Text>
                </RectButton>
